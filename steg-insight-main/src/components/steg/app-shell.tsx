...
const nav: NavItem[] = [
  ...
  { to: "/users", label: "Utilisateurs", icon: Settings, permission: "users:manage" },
];
            ...
            {user && (
              <>
                ...
                <button
                  ...
                  className="grid size-9 place-items-center rounded-lg bg-secondary text-secondary-foreground transition-colors hover:bg-danger/12 hover:text-danger"
